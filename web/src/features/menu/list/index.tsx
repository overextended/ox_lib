...
const useStyles = createStyles((theme, params: { position?: MenuPosition; itemCount: number; selected: number }) => ({
  ...
  container: {
    position: 'absolute',
    pointerEvents: 'none',
    marginTop: params.position === 'top-left' || params.position === 'top-right' ? '0.3125rem' : 0,
    marginLeft: params.position === 'top-left' || params.position === 'bottom-left' ? '0.3125rem' : 0,
    marginRight: params.position === 'top-right' || params.position === 'bottom-right' ? '0.3125rem' : 0,
    marginBottom: params.position === 'bottom-left' || params.position === 'bottom-right' ? '0.3125rem' : 0,
