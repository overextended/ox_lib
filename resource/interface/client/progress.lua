...
local function startProgress(data)
    ...
    local controls = {
        ...
        ['INPUT_SPRINT'] = cache.game == 'fivem' and 21 or 0x8FFC75D6,
        ['INPUT_AIM'] = cache.game == 'fivem' and 25 or 0xF84FA74F,
        ['INPUT_MOVE_LR'] = cache.game == 'fivem' and 30 or 0x4D8FB4C1,
        ['INPUT_MOVE_UD'] = cache.game == 'fivem' and 31 or 0xFDA83190,
        ['INPUT_DUCK'] = cache.game == 'fivem' and 36 or 0xDB096B85,
        ['INPUT_VEH_MOVE_LEFT_ONLY'] = cache.game == 'fivem' and 63 or 0x9DF54706,
        ['INPUT_VEH_MOVE_RIGHT_ONLY'] = cache.game == 'fivem' and 64 or 0x97A8FD98,
        ['INPUT_VEH_ACCELERATE'] = cache.game == 'fivem' and 71 or 0x5B9FD4E2,
        ['INPUT_VEH_BRAKE'] = cache.game == 'fivem' and 72 or 0x6E1F639B,
        ['INPUT_VEH_EXIT'] = cache.game == 'fivem' and 75 or 0xFEFAB9B4,
        ['INPUT_VEH_MOUSE_CONTROL_OVERRIDE'] = cache.game == 'fivem' and 106 or 0x39CCABD5
    }
